...
public class ProfileController {
    ...
    public ResponseEntity<Page<ConsultantListRes>> getMyConsultantList(@PathVariable("user_id") Long userId,
    ...
    public ResponseEntity<Map<String, Page<ReviewListRes>>> userReceivedReview(@PathVariable("user_id") Long userId,
        ...
        if (user.isConsultant()) {
            ConsultantProfile consultantProfile = profileService.getConsultantProfile(user.getId())
                    .orElse(null);
