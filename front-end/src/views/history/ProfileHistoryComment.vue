...
export default {
  name: "ProfileHistoryComment",
  setup () {
    const store = useStore()
    const router = useRouter()
    const state = reactive ({
      userInfo: computed(() => store.getters['root/userInfo']),
      profileHistoryComment: computed(() => store.getters['root/profileHistoryComment']),
      profileHistoryCommentLastPageNum: computed(() => store.getters['root/profileHistoryCommentLastPageNum']),
      commentpage: 1,
    })
    ...
    const checkCommentPage = async function(event) {
      let targetId = event.currentTarget.id;
      if(targetId == "comment_prev") {
        state.commentpage -= 1;
      }
      else if(targetId == "comment_next") {
        state.commentpage += 1;
      }
      ...
      prcommunity.setAttribute('data-state', state.commentpage===1 ? 'disabled' : '')
      if (state.commentpage===1) {
        prcommunity.disabled = true
      } else {
        prcommunity.disabled = false
      }
      plcommunity.setAttribute('data-state', state.commentpage===state.profileHistoryCommentLastPageNum ? 'disabled' : '')
      if (state.commentpage === state.profileHistoryCommentLastPageNum) {
        plcommunity.disabled = true
      } else {
        plcommunity.disabled = false
      ...
      await store.dispatch("root/profileGetHistoryCommentPageSearch", {
    ...
    return { state, onMounted, checkCommentPage, goToCommunity }
  }
}
</script>
...
.paginatecomment.left i:first-child {
  transform: translate(0, -1px) rotate(40deg);
}
.paginatecomment.left i:last-child {
  transform: translate(0, 1px) rotate(-40deg);
}
.paginatecomment.left:hover i:first-child {
  transform: translate(0, -1px) rotate(30deg);
}
.paginatecomment.left:hover i:last-child {
  transform: translate(0, 1px) rotate(-30deg);
}
.paginatecomment.left:active i:first-child {
  transform: translate(1px, -1px) rotate(25deg);
}
.paginatecomment.left:active i:last-child {
  transform: translate(1px, 1px) rotate(-25deg);
}
.paginatecomment.left[data-state=disabled] i:first-child {
  transform: translate(-5px, 0) rotate(0deg);
}
.paginatecomment.left[data-state=disabled] i:last-child {
  transform: translate(-5px, 0) rotate(0deg);
}
.paginatecomment.left[data-state=disabled]:hover i:first-child {
  transform: translate(-5px, 0) rotate(0deg);
}
.paginatecomment.left[data-state=disabled]:hover i:last-child {
  transform: translate(-5px, 0) rotate(0deg);
}
...
.paginatecomment.right i:first-child {
  transform: translate(0, 1px) rotate(40deg);
}
.paginatecomment.right i:last-child {
  transform: translate(0, -1px) rotate(-40deg);
}
.paginatecomment.right:hover i:first-child {
  transform: translate(0, 1px) rotate(30deg);
}
.paginatecomment.right:hover i:last-child {
  transform: translate(0, -1px) rotate(-30deg);
}
.paginatecomment.right:active i:first-child {
  transform: translate(1px, 1px) rotate(25deg);
}
.paginatecomment.right:active i:last-child {
  transform: translate(1px, -1px) rotate(-25deg);
}
.paginatecomment.right[data-state=disabled] i:first-child {
  transform: translate(5px, 0) rotate(0deg);
}
.paginatecomment.right[data-state=disabled] i:last-child {
  transform: translate(5px, 0) rotate(0deg);
}
.paginatecomment.right[data-state=disabled]:hover i:first-child {
  transform: translate(5px, 0) rotate(0deg);
}
.paginatecomment.right[data-state=disabled]:hover i:last-child {
  transform: translate(5px, 0) rotate(0deg);
}
.paginatecomment[data-state=disabled] {
  opacity: 0.3;
  cursor: default;
}
